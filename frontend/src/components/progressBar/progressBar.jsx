...
function ProgressBar() {
  ...
  const steps = [
    { label1: "STEP 1", label2: "Basic details", url: "/signup/basic-details" },
    { label1: "STEP 2", label2: "Strengths?", url: "/signup/strengths" },
    { label1: "STEP 3", label2: "Interest?", url: "/signup/interest" },
    { label1: "STEP 4", label2: "Sign-up/ login", url: "/signup/modal" }
  ];
