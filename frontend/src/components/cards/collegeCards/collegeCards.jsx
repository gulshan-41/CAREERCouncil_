...
function CollegeCard({ name, location, ownership, ranking, totalCharges, visitLink }) {
    ...
    return (
        <div className="college-card-wrapper">
            ...
            <div className="college-card-vr-ruler"></div>
            <div className="total-charges-brochure">
