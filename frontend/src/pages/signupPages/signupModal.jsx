                        ...
                        <form onSubmit={handleSignup}>
                            ...
                            <div className="agree-personal-data">
                                <input
                                    ...
                                    name="personal-data"
                                    id="personalData"
                                    checked={surveyData.agreeToDataProcessing || false}
                                    onChange={(e) => updateSurveyData("agreeToDataProcessing", e.target.checked)}
                                />
                                <label htmlFor="personalData">I agree to the processing of personal data</label>
                            </div>
